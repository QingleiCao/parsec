...
struct parsec_data_s {
    ...
    size_t                     nb_elts;          /* logical size in bytes of the memory layout */
    size_t                     nb_elts_alloc;    /* allocated capacity in bytes for device buffers.
                                                  * 0 means "unset" and should fallback to nb_elts.
                                                  */
